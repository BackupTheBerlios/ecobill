 ...
 */
public class DescriptionTable extends JPanel implements Internationalization, Persistable {

    /**
     * In diesem <code>Log</code> können Fehler, Info oder sonstige Ausgaben erfolgen.
     * Diese Ausgaben können in einem separaten File spezifiziert werden.
     */
    private static final Log LOG = LogFactory.getLog(DescriptionTable.class);
    ...
    /**
     * Erzeugt eine neues Description Table Panel für Artikel.
     */
    public DescriptionTable(ArticleUI articleUI, BaseService baseService) {
