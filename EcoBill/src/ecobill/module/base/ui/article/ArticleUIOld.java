...
public class ArticleUIOld extends JPanel implements InitializingBean, Internationalization {
    ...
    /**
     * Die <code>ArticleUIOld</code> stellt ein Singleton dar, da es immer nur eine
     * Instanz pro Arbeitsplatz geben kann.
     * -> spart kostbare Ressourcen.
     */
    private static ArticleUIOld singelton = null;

    /**
     * Gibt die einzigste Instanz der <code>ArticleUIOld</code> zurück um diese
     * dann bspw im Hauptfenster anzeigen zu können.
     *
     * @return Die <code>ArticleUIOld</code> ist abgeleitet von <code>JInternalFrame</code>
     *         und kann auf einer <code>JDesktopPane</code> angezeigt werden.
     */
    public static ArticleUIOld getInstance() {
        if (singelton == null) {
            singelton = new ArticleUIOld();
        }
        return singelton;
    }
...
/*      /*
        ...
        */
        ...
        saveB.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                Article article = ArticleUIOld.this.saveOrUpdateArticle();
                //ArticleUIOld.this.addArticleToTableModel(article);
                ArticleUIOld.this.renewArticleTableModel();
            }
        });
    }
    ...
    private void initOverviewBottomP() {
        ...
        this.articleTable.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                ...
                if (e.getButton() == MouseEvent.BUTTON1) {
                    ArticleUIOld.this.showArticle(getArticleNumberOfSelectedRow(0));
                }
            }
        });
        ...
        this.articleTable.addKeyListener(new KeyAdapter() {
            public void keyPressed(KeyEvent e) {
                ...
                ArticleUIOld.this.showArticle(selectedArticleNumber);
            }
        });
    }
                ...
                if (e.getType() == TableModelEvent.UPDATE) {
                    ...
                    if (tableModel != null && rowFirst > -1) {
                        ...
                        if (articleNumberObj instanceof String) {
                            ...
                            ArticleUIOld.this.renewArticleTableModel();
                            ArticleUIOld.this.renewArticleDescriptionTableModel(article);
                        }
                    }
                }
            }
    ...
    private String getArticleNumberOfSelectedRow(int rowDifferece) {
        ...
        */
        Object objId = null;
        try {
            objId = ArticleUIOld.this.articleTableModel.getValueAt(row, 0);
        }
        catch (Exception e) {
